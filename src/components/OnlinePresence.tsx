...
import {FaGithub, FaBlogger, FaYoutube, FaLink } from 'react-icons/fa';
...
const platforms: Platform[] = [
    { name: "GitHub Repository", url: "https://github.com/gisioraelvis/", icon: <FaGithub className="text-4xl text-gray-400" />, description: "Source code, projects, and version control activities." },
    { name: "Facebook", url: "https://www.facebook.com/100094263223978", icon: <FaBlogger className="text-4xl text-orange-400" />, description: "Sharing insights on BBIT, data analysis, or IT concepts." },
